...
const icons = {
  ...
  delivery:  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 17a2 2 0 104 0m-4 0a2 2 0 114 0m-4 0H5.5A2.5 2.5 0 013 14.5V8a2 2 0 012-2h9v11M12 17h4m0 0a2 2 0 104 0m-4 0a2 2 0 114 0m0 0h1a2 2 0 002-2v-3.5a2 2 0 00-.4-1.2l-1.5-2A2 2 0 0015.5 7H14" />,
...
const NAV_ITEMS = [
  ...
  { label: 'Delivery',  path: '/delivery-persons', icon: 'delivery' },
